...
const ACTION_OPTIONS = [
  ...
  { value: "change_role", label: "Zmiana roli" },
  { value: "change_password", label: "Zmiana hasła" },
  { value: "reset_password", label: "Reset hasła" },
  { value: "change_plan", label: "Zmiana planu" },
  { value: "reset_usage", label: "Reset limitu" },
  { value: "set_limit", label: "Ustawienie limitu" },
];
    ...
    <div className="flex flex-col gap-2 sm:flex-row">
      <div className="relative flex-1">
        ...
        <input
          ...
          placeholder="Szukaj po emailu admina…"
